...
// build array maps of the form inputs & control groups //
	...
	this.formFields = [$('#name-tf'), $('#email-tf'), $('#user-tf'), $('#pass-tf'),$('#pass-tf1')];
	this.controlGroups = [$('#name-cg'), $('#email-cg'), $('#user-cg'), $('#pass-cg'),$('#pass-cg1')];
...
// bind the form-error modal window to this controller to display any errors //
    ...
    this.validateBothPassword = function(s,y)
    {
...
AccountValidator.prototype.validateForm = function()
{
    ...
    if (this.validateBothPassword(this.formFields[3].val(),this.formFields[4].val()) == false) {
        this.controlGroups[4].addClass('error');
        e.push('Both Password should be Same');
    }
